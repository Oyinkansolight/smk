  ...
  return (
    <div className='flex gap-8 bg-[#F2F5FF] border-2 items-center p-4 rounded-lg'>
      ...
      <div className='flex flex-col gap-3 flex-1'>
        ...
        <div className='text-[#615E83] font-bold text-2xl leading-7'>Mathematics</div>
        <div>
      ...
      <Button className='rounded-lg bg-[#3361FF] max-w-[142px] max-h-[36px]' variant='secondary'>Go To Period</Button>
    </div>
  );
}
