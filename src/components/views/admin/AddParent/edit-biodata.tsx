      ...
      <div className='my-10 grid md:grid-cols-2 gap-6'>
        <div>
          <FormInput
            ...
            name='firstName'
            register={register}
            formValue={parentDetail?.firstName}
            validation={{
        ...
        <div>
          <FormInput
            ...
            placeholder='Details here'
            register={register}
            formValue={parentDetail?.lastName}
            validation={{
      ...
      <div className='my-10 grid md:grid-cols-2 gap-6'>
        ...
        <div>
          <FormInput
            ...
            label='Address'
            placeholder='Details here'
            formValue={parentDetail?.address}
            register={register}
            validation={{
...
export default EditParentBioData;
