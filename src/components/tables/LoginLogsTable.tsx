...
const columns: TableColumn<LoginLogsTableProps>[] = [
  {
    ...
    cell: (event) => (
      <div className='text-sm flex items-center gap-2 font-medium whitespace-nowrap overflow-hidden'>
        <div className='h-6 w-6 min-h-[24px] min-w-[24px] rounded-full bg-gray-200' />
        <div className='grid grid-cols-2 gap-2 xl:gap-10'>
          ...
          <div className='bg-[#FFF3EF] text-center text-[6px] lg:text-[8px] font-normal text-[#FF6633] lg:py-1 px-2 rounded-full min-w-[40px] max-w-[80px] overflow-hidden text-ellipsis'>
            {event.user.type}
          </div>
        </div>
      </div>
