    ...
    return (
        <BasicCard
            className={clsxm(
                ...
                '!m-0 flex h-[156px] w-full min-w-[180px] items-center whitespace-nowrap !rounded-[9px] px-[36px] py-[21px] shadow-sm lg:w-[230px]'
            )}
        >
            <div className='flex flex-col gap-8'>
                <div className='flex flex-col gap-2'>
                    ...
                    <div className='text-4 font-semibold capitalize'>
                        {title}
                    </div>
                </div>
