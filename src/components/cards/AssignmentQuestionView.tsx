        ...
        {options.map((option, idx) => (
          <div
            ...
            className={clsxm(
              ...
              showAssessment &&
              'border-[#1BB449]',
              showAssessment && studentAnswer !== correctOption && idx === studentAnswer && 'border-[#FF0000]'
            )}
          >
            <div
              className={clsxm(
                ...
                idx === correctOption &&
                idx === selectedOption &&
                showAssessment || (studentAnswer === correctOption && studentAnswer === idx) &&
                'border-[#1BB449]',
                showAssessment && studentAnswer !== correctOption && idx === studentAnswer && 'border-[#FF0000]'
              )}
            >
              {selectedOption === idx && (
                <div
                  className={clsxm(
                    ...
                    showAssessment && studentAnswer !== correctOption && idx === studentAnswer && 'bg-[#FF0000]'
                  )}
                />
              )}
            </div>
            ...
            {studentAnswer === idx &&
              ...
              showAssessment && (
                <>
                  <div className='flex-1' />
                  <TbCircleCheckFilled className='text-[#FF0000] h-5 w-5' />
                </>
              )}
          </div>
        ))}
