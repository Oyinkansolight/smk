      ...
      <div className='flex lg:flex-row flex-col gap-4'>
        <div className='flex-1 rounded-lg bg-white min-h-[50rem] overflow-hidden w-full'>
          <div className='flex justify-start p-4'>
                ...
                >
                  ...
                  <div className='w-full'>
                    <AssignmentQuestionView
                      ...
                      studentAnswer={
                        submissions?.[0]?.answers?.[idx]?.answerOption
                      }
                    />
                  </div>
                </div>
            ...
            {submissions?.[0]?.activity?.format === 'SUBJECTIVE' &&
              submissions?.[0]?.activity?.questionsV2[0]?.question && (
                <div className='flex flex-col gap-10'>
                  ...
                  <div className='flex flex-col gap-4'>
                    ...
                    <div className='-mt-10'>
                      <SubjectiveViewer
                        content={submissions?.[0]?.answers?.[0]?.answerText}
                      />
                    </div>
                  </div>
                </div>
        ...
        <div className=' rounded-lg bg-white p-4'>
          ...
          <div className='flex flex-col gap-4 mt-6'>
            ...
            <EditStudentGrade
              questions={submissions?.[0]?.activity?.questionsV2}
              setScores={setScores}
              handleGrading={handleGrading}
            />
          </div>
        </div>
      </div>
...
function EditableFormSelect({
  isEditing,
  handleScoreChange,
}: {
  isEditing: boolean;
  handleScoreChange: (score: number, idx: number) => void;
}) {
