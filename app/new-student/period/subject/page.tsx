      ...
      <div className='flex flex-row gap-8 justify-between'>
        <div className='flex flex-col gap-5 w-full'>
          ...
          <div className='border border-[#D5D7D8] rounded-md grid grid-cols-2 gap-6 p-4 bg-[#FAFAFA]'>
            <Link
              href='/new-student/period/note?name=Mathematics'
            ...
            <Link
              href='/new-student/period/classwork?name=Mathematics'
            ...
            <Link
              href='/new-student/period/quiz?name=Mathematics'
              className='h-[250px] w-full rounded-lg bg-[#F4EFF7] grid place-content-center text-center'
            >
              <Image src='/svg/quiz.svg' width={180} height={175} alt='quiz' />
