  ...
  return (
    <div className='flex gapx-4 gap-y-10'>
      ...
      <div className='w-full px-4'>
        ...
        <div className='grid grid-cols-3 p-2 gap-8  bg-[#F9F9F9] rounded '>
          <Result
            Icon={Lightup}
            upperLimit='98'
            lowerLimit='120'
        ...
        <div className='p-3  bg-[#F9F9F9] rounded '>
          ...
          <div className='bg-white rounded-lg p-3'>
            <div className='grid grid-cols-12 mb-4 text-gray-500 text-xs'>
            ...
            <div className='grid grid-cols-12 mb-4 font-medium text-xs'>
              <div className='col-span-3'>
