...
const AllStudent = () => {
  ...
  const { data: StudentTypeCount } = useGetStudentCountType({
    userType: 'STUDENT',
  });
  console.log('Count', StudentTypeCount);
      ...
      <div className='rounded-2xl p-4 bg-[#FFF4DF]'>
        ...
        <div className='space-y-4 my-4 pt-4'>
          <InstituteTypeCard
            ...
            count={StudentTypeCount?.ECCDE ?? 0}
          />
          <InstituteTypeCard
            type='Primary'
            title='Total Primary Students'
            count={StudentTypeCount?.PRIMARY ?? 0}
          />
          <InstituteTypeCard
            type='Secondary'
            title='Total Secondary Students'
            count={StudentTypeCount?.SECONDARY ?? 0}
          />
          <InstituteTypeCard
            type='Tertiary'
            title='Total Tertiary Students'
            count={StudentTypeCount?.TVET ?? 0}
          />
        </div>
      </div>
