...
const AddStudent = () => {
  ...
  const [tertiary, settertiary] = useState(mockData);
  ...
  return (
    <section className='md:px-[60px] px-5 py-6'>
      ...
      <h1 className='mt-5 mb-6 text-2xl font-bold'>Tertiary Schools</h1>

      <div className='mb-6 flex justify-between items-end'>
        <div className='bg-[#FFF6EC] p-3 rounded-2xl w-[200px]'>
          <p className='text-[#615F5F]'>Total Tertiary Schools</p>
